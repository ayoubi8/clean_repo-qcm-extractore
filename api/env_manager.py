...
EDITABLE_KEYS = {
    ...
    "STEP2_MODEL", "STEP2_FALLBACK_MODEL", "STEP2_MAX_TOKENS", "STEP2_MAX_RETRIES", "STEP2_MAX_TOKENS_CEILING",
    "STEP3_MODEL", "STEP3_FALLBACK_MODEL",
    "CC_CHECKER_MODEL", "CC_CHECKER_FALLBACK_MODEL", "CC_CHECKER_MAX_TOKENS",
    "STEP6_TEXT_MODEL", "STEP6_TEXT_FALLBACK_MODEL",
    "STEP6_ALL_PAGES_MODEL", "STEP6_ALL_PAGES_FALLBACK_MODEL", "STEP6_ALL_PAGES_MAX_TOKENS",
    "STEP6_AI_MODEL", "STEP6_AI_FALLBACK_MODEL", "STEP6_AI_MAX_TOKENS",
